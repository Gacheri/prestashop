                    Bitnami PrestaShop Stack 1.7.7.2-0
                  ==============================
...
bitnami-prestashop-1.7.7.2-0-linux-installer.run on Linux or
bitnami-prestashop-1.7.7.2-0-linux-x64-installer.run on Linux 64 bit or
bitnami-prestashop-1.7.7.2-0-windows-installer.exe on Windows or
bitnami-prestashop-1.7.7.2-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-prestashop-1.7.7.2-0-linux.run
...
in /home/user/prestashop-1.7.7.2-0 on Linux or C:\Bitnami\Bitnami PrestaShop Stack
on Windows or /Applications/prestashop-1.7.7.2-0 on OS X and that you use port 8080 
...
/home/user/prestashop-1.7.7.2-0/apache2/logs/error.log on Linux or
C:\Bitnami\Bitnami PrestaShop Stack\apache2\logs\error.log on Windows or
/Applications/prestashop-1.7.7.2-0/apache2/logs/error.log.
